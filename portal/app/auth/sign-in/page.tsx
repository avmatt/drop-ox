  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-zinc-100 p-6">
      <main className="w-full max-w-xl rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        <p className="mb-2 text-xs font-semibold uppercase tracking-[0.12em] text-zinc-500">Authentication</p>
        <h1 className="mb-3 text-3xl font-semibold tracking-tight text-zinc-900">Sign In</h1>
        <p className="mb-8 text-zinc-600">
          Sign in with Microsoft Entra ID to access the portal.
        </p>
